...
const Header = () => {
  return (
    <nav className="container mx-auto flex items-center justify-between px-4 h-14 md:h-24">
      <div className="flex items-center gap-3 bg-light-primary dark:bg-dark-primary z-20 pr-2 pb-2 mt-2">
        ...
        <span className="text-light-content md:inline hidden dark:text-dark-content uppercase text-2xl">
          Mehrdad Azizkhani
        </span>
      </div>
      <div className="flex items-center gap-4 bg-light-primary dark:bg-dark-primary z-20 pl-2 pb-2 mt-2">
        <a
          className="social"
